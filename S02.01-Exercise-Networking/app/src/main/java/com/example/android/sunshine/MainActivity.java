...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Completed (3)  the for loop that populates the TextView with dummy data
        /*
    ...
    public  class WeatherAsyncTask extends AsyncTask<String, Void, String[]> {
        ...
        @Override
        protected void onPostExecute(String[] weatherdData) {
            if (weatherdData!=null){
        for (String weatherString:weatherdData){
